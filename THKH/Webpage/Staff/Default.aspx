                ...
                <div class="row" id="userData">
                    ...
                    <div id="staticinfocontainer" class="col-sm-6" style="text-align: left">
                        <div class="jumbotron" style="text-align: left">
                            ...
                            <%--Visit Time--%>
                            <label for="visitbookingtime">
                                <span style="color: lightcoral">*</span>Intended Visit Time (
                                :mm)</label>
                            <div class="form-group">
                    ...
                    <div class="col-sm-8 row" id="userInfo" style="overflow-y: auto">
                        ...
                        <div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="staffFirstName" class="form-control required userInput" />
                                </div>
                                <label><span style="color: lightcoral">*</span>Last Name</label>
                                <div class="form-group">
                                    <input id="staffLastName" class="form-control required userInput" />
                                </div>
                                <label>NRIC</label>
                                <div class="form-group">
                                ...
                                <label>Address</label>
                                <div class="form-group">
                                    <input id="staffAddress" class="form-control userInput" />
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="staffTitle" class="form-control required userInput" />
                                </div>
                                ...
                                <div class="form-group">
                                    <input id="staffPwd" type="password" class="form-control required userInput" />
                                </div>
                            </div>
                        ...
                        <div class="panel-body" style="overflow-y: auto; height: calc(100% - 40px);">
                            ...
                            <div class="row">
                                ...
                                <div>
                                    ...
                                    <label>Resizable:</label><input type="checkbox" id="textSizeable" />
                                </div>
