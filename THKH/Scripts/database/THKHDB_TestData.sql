...
BEGIN
	...
	BEGIN
		INSERT INTO VISIT
		VALUES ('2015-01-29 10:00:00', 'S1111222A', 'Visiting', 'Sex', NULL, '1202', 'FIRST_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2015-01-29 12:00:00', 'S3333444B', 'Visiting', 'Sex', NULL, '1202', 'FIRST_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2015-01-29 14:00:00', 'S3333444B', 'Visiting', 'Sex', NULL, '1202', 'FIRST_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2015-01-29 16:00:00', 'S3333444B', 'Visiting', 'Sex', NULL, '1202', 'FIRST_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2015-01-29 18:00:00', 'S3333444B', 'Visiting', 'Sex', NULL, '1202', 'SECOND_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2015-01-29 19:00:00', 'S5555666Z', 'Other Purpose', 'Delivery', 'CAFETERIA', NULL, 'FIRST_ANS_ID', '', 1, SYSDATETIME())
	END 
...
BEGIN
	BEGIN
		INSERT INTO VISIT
		VALUES ('2017-02-01 10:00:00', 'S123', 'Visiting', 'Shagging', NULL, '1101,1104', 'FIRST_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2017-02-01 12:00:00', 'S456', 'Visiting', 'Shagging', NULL, '1101', 'FIRST_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2017-02-01 14:00:00', 'S789', 'Visiting', 'Shagging', NULL, '1104', 'FIRST_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2017-02-02 16:00:00', 'S246', 'Visiting', 'Shagging', NULL, '1101', 'FIRST_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2017-02-02 18:00:00', 'S629', 'Visiting', 'Shagging', NULL, '1104', 'FIRST_ANS_ID', '', 1, SYSDATETIME())

		INSERT INTO VISIT
		VALUES ('2017-02-01 19:00:00', 'S123', 'Other Purpose', 'Delivery', 'CAFETERIA', NULL, 'FIRST_ANS_ID', '', 1, SYSDATETIME())
	END 
